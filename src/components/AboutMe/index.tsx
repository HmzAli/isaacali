        ...
        <div className="about-item__content">
          <div className="row">
            <div className="col-md-8">
              <h3>About me</h3>
              <p>
                I'm a web developer with over 10 years of experience bringing digital designs to life for millions of users. I transform ideas into pixel-perfect, high-performing websites with technical precision and attention to detail.
              </p>
